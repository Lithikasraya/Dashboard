      ...
      <div className="flex items-center gap-3">
        <div className="hidden md:flex relative">
          ...
          <input 
            ...
            className="pl-10 pr-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-sm focus:ring-2 focus:ring-amber-500/20 outline-none transition-all w-64"
          />
        </div>
      </div>
    </nav>
